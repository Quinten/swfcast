package 
{
	 ...
	 */
	public class hypercrossfour extends MovieClip 
	{
		...
		public var lineColor:Array = [0xffffff, 0x000000, 0xcccccc, 0x999999];
		...
		public function hypercrossfour():void 
		{	
			...
			lineColor = (commonObj.data.fluxCast) ? commonObj.data.fluxCast.colors : lineColor;
		...
		public function init3D():void
		{
			...
			for (var c:int = 0; c < nCubeDrops; c++ )
			{
				...
				cubeDrop[c] = new Lines3D(new LineMaterial(lineColor[0],0.25));
				// bottom
				cubeDrop[c].addNewSegmentedLine(2,1,-cubeSize,0,cubeSize,-cubeSize,0,-cubeSize);
				cubeDrop[c].material = new LineMaterial(lineColor[1],0.25);
				cubeDrop[c].addNewSegmentedLine(2,1,-cubeSize,0,-cubeSize,cubeSize,0,-cubeSize);
				cubeDrop[c].material = new LineMaterial(lineColor[2],0.25);
				cubeDrop[c].addNewSegmentedLine(2,1,cubeSize,0,-cubeSize,cubeSize,0,cubeSize);
				cubeDrop[c].material = new LineMaterial(lineColor[3],0.25);
