package 
{
	 ...
	 */
	public class hypercilynderfixed extends MovieClip 
	{
		...
		public function hypercilynderfixed():void 
		{	
		...
		public function init3D():void
		{
			...
			for (var c:int = 0; c < nCubeDrops; c++ )
			{
				...
				var extraObj:Object = new Object(); 
				extraObj.nRoll = - Math.random()*3 + Math.random()*6;
				extraObj.nYaw = - Math.random()*3 + Math.random()*6;
				extraObj.nPitch = - Math.random()*3 + Math.random()*6;
